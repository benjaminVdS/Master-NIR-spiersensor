...
void initiateBLE(void){
	...
	//a= LEUART_Rx(LEUART0);
#if DEBUG_DBPRINT == 1 /* DEBUG_DBPRINT */
	dbprintln("Set RF_ScanFlags to 0x00: Enable Active scanning");
#endif /* DEBUG_DBPRINT */
	parameter[0] = 0x00;
	sendCommandtoDEV(startS, CMD_SET_REQ, LengthPayload2 , RF_ScanFlags, parameter);
	// Set RF_SecFlags:
#if DEBUG_DBPRINT == 1 /* DEBUG_DBPRINT */
	...
	// Set RF_TxPower
#if DEBUG_DBPRINT == 1 /* DEBUG_DBPRINT */
	dbprintln("Set Tx_power: ");
#endif /* DEBUG_DBPRINT */
	parameter[0] = 0x00; // Set op 0Db
...
//sendCommandtoDEV(0x02, 0x04, LengthPayload243 , 0x00, hello1);
#if DEBUG_DBPRINT == 1 /* DEBUG_DBPRINT */
    ...
    /*dbprintln("CMD_SCANSTART_REQ");
    sendCommandtoDEV(startS, CMD_SCANSTART_REQ, LengthPayload0 , 0x00, parameter);

    delayMs(4000);

	//CMD_SCANSTOP_REQ
	dbprintln("CMD_SCANSTOP_REQ");
	sendCommandtoDEV(startS, CMD_SCANSTOP_REQ, LengthPayload0 , 0x00, parameter);*/
